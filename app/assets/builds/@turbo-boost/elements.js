import"@turbo-boost/commands";var K=Object.defineProperty,U=Object.defineProperties,X=Object.getOwnPropertyDescriptors,H=Object.getOwnPropertySymbols,Y=Object.prototype.hasOwnProperty,Q=Object.prototype.propertyIsEnumerable,O=(t,e,o)=>e in t?K(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o,c=(t,e)=>{for(var o in e||(e={}))Y.call(e,o)&&O(t,o,e[o]);if(H)for(var o of H(e))Q.call(e,o)&&O(t,o,e[o]);return t},h=(t,e)=>U(t,X(e));function Z(t){let e=document.createElement("template");return e.innerHTML=t,e}function $(t,e){e=e||document.body;let o=Z(t).content.cloneNode(!0).querySelector("*");return e.appendChild(o)}function w(t,e={}){if(!t)return;L(t);let{outline:o,outlineOffset:r}=e;o=o||"dashed 3px red",r=r||"0px",t.originalStyles=t.originalStyles||{display:t.style.display,minHeight:t.style.minHeight,minWidth:t.style.minWidth,outline:t.style.outline,outlineOffset:t.style.outlineOffset},getComputedStyle(t).display.match(/^inline$/i)&&t.offsetWidth===0&&t.offsetHeight===0&&(t.style.display="inline-block",t.style.minHeight="2px",t.style.minWidth="2px"),t.style.outline=o,t.style.outlineOffset=r,t.dataset.turboBoostHighlight=!0}function L(t){if(t){if(t.originalStyles){for(let[e,o]of Object.entries(t.originalStyles))o?t.style[e]=o:t.style[e]="";delete t.originalStyles}delete t.dataset.turboBoostHighlight}}function k(t){if(!t)return{};let e=t.getBoundingClientRect(),o=t.offsetWidth,r=t.offsetHeight,s=e.top+window.scrollY,i=e.left+window.scrollX,n=i+o,g=s+r;return{top:s,left:i,right:n,bottom:g,width:o,height:r}}function b(t){try{t()}catch(e){}}var ee=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=this.html,this.labelElement.addEventListener("click",t=>{t.preventDefault(),this.toggle()}),this.checkboxElement.addEventListener("change",t=>this.dispatchEvent(new CustomEvent("change",{bubbles:!0})))}toggle(){this.checked?this.uncheck():this.check()}check(){this.checkboxElement.checked=!0,this.dispatchEvent(new CustomEvent("change",{bubbles:!0}))}uncheck(){this.checkboxElement.checked=!1,this.dispatchEvent(new CustomEvent("change",{bubbles:!0}))}get name(){return this.getAttribute("name")}get checked(){return this.checkboxElement.checked}get checkboxElement(){return this.shadowRoot.querySelector("input")}get labelElement(){return this.shadowRoot.querySelector("label")}get html(){return`
    ...
    `}},u=[],re={LeaderLine:{src:"https://cdnjs.cloudflare.com/ajax/libs/leader-line/1.0.7/leader-line.min.js",integrity:"sha512-0dNdzMjpT6pJdFGF1DwybFCfm3K/lzHhxaMXC/92J9/DZujHlqYFqmhTOAoD0o+LkeEsVK2ar/ESs7/Q2B6wJg==",global:"LeaderLine"},PlainDraggable:{src:"https://cdn.jsdelivr.net/npm/plain-draggable@2.5.14/plain-draggable.min.js",global:"PlainDraggable"}};function ie(t){return t.global&&self[t.global]||document.querySelector(`[src='${t.src}']`)?!0:u.includes(t)}function se(t){if(ie(t))return;u.push(t);let{src:e,integrity:o}=t,r=document.createElement("script");r.setAttribute("src",e),r.setAttribute("crossorigin","anonymous"),r.setAttribute("referrerpolicy","no-referrer"),o&&r.setAttribute("integrity",o),document.head.appendChild(r)}function M(t){if(!u.includes(t))return;u.splice(u.indexOf(t),1);let{src:e}=t,o=document.querySelector(`script[src='${e}']`);o&&o.remove(),t.global&&self[t.global]&&(self[t.global]=null)}function le(){[...u].forEach(t=>M(t))}var p=h(c({},re),{add:se,remove:M,removeAll:le});customElements.define("turbo-boost-devtool",ee);customElements.define("turbo-boost-devtool-supervisor",te);customElements.define("turbo-boost-devtool-tooltip",oe);var l;function j(){if(l)try{new PlainDraggable(l)}catch(t){setTimeout(j,200)}}function A(){q()||(l.close(),l.dispatchEvent(new CustomEvent("turbo-boost:devtools-stop",{bubbles:!0})),l=null,p.removeAll())}function I(){y()||(p.add(p.LeaderLine),p.add(p.PlainDraggable),l=$("<turbo-boost-devtool-supervisor></turbo-boost-devtool-supervisor>"),setTimeout(j,200),l.dispatchEvent(new CustomEvent("turbo-boost:devtools-start",{bubbles:!0})))}function ne(){let t=l?Object.keys(l.enabledDevtools):[];A(),I(),l.devtoolElements.forEach(e=>{t.includes(e.name)&&e.check()})}function y(){return!!l}function q(){return!y()}var R;function N(){clearTimeout(R),R=setTimeout(ne,25)}function v(){y()&&N()}addEventListener("turbo:load",v);addEventListener("turbo-frame:load",v);addEventListener("turbo-boost:devtools-connect",v);addEventListener("turbo-boost:devtools-close",A);window.TurboBoost&&(addEventListener(TurboBoost.Commands.events.success,v),addEventListener(TurboBoost.Commands.events.finish,v));function ae(t,e){if(l)return $(`
      <turbo-boost-devtool name="${t}" slot="devtool">
        <span slot="label">${e}</span>
      </turbo-boost-devtool>
    `,l)}function de(t){return l?l.enabledDevtools[t]:!1}var S={enabled:de,register:ae,start:I,stop:A,restart:N,get started(){return y()},get stopped(){return q()}};function x(t,e,o,r={}){let{backgroundColor:s,color:i,position:n,id:g}=r;return i=i||"white",n=n||"top",$(`
...
`,content:`
      ...
      ${e}
    `}}};customElements.define("turbo-boost",a);customElements.define("turbo-boost-toggle-target",f);customElements.define("turbo-boost-toggle-trigger",E);self.TurboBoost=self.TurboBoost||{};self.TurboBoost.devtools=P;self.TurboBoost.Elements={VERSION:F};var ze=self.TurboBoost.Elements;export{ze as default};
